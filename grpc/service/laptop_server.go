...
// RateLaptop is bidirectional-streaming RPC that allows client to rate a stream of laptops
// with a score, and returns a streaming of average score for each of them
